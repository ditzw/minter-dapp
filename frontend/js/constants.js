const contractAddress = "0x8a3E11feC33C2344532586003AdacEA0AE6A7c44"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the AlienGang NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The AlienGang NFT Project is a collection of 5000 unique Alien NFTS & unique digital collectibles, Purchase one NFT and Join The Alien Gang';
